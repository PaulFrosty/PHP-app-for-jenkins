...
<body>
    <section class="congratulations">
        <h1>Congratulations <font color=pink>DevOPS engineer</font></h1>
        <p>Jenkins job <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
